...
def stochasticGradecent(data,weight,time):
	...
	for  i in range(21):
		grad[i]=put*data[time][i]*data[time][21]
	return grad
...
batchein=calculateErrorlogistic(batchweight,traindata)
stocein=calculateErrorlogistic(stochasticweight,traindata)
print("batchein=",batchein)
print("stocein=",stocein)
